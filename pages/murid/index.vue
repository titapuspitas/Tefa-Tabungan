<template>
  <div class="container-fluid">
    <div class="row justify-content-evenly">
      ...
      <div class="col-md-3 m-3 d-flex justify-content-end align-items-center riwayat text-center"><nuxt-link to="/riwayats" class="test"> Riwayat <i class="ms-5 bi bi-pie-chart-fill zoom"></i></nuxt-link></div>
    </div>
  </div>
</template>
